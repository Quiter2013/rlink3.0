package com.robustel.auth.client.aop;

import com.robustel.auth.client.annotation.PreAuth;
import com.robustel.auth.client.security.CustomerSecurityExpressionRoot;
...
public class AuthAspect {
    ...
    @Pointcut("@annotation(com.robustel.auth.client.annotation.PreAuth)")
    private void cut() {
    }
