...
/**
 * @Author: gaolinlou
 * Description: 替换druid-spring-boot-start中的DruidDataSourceWrapper访问权限是为public
 * Date: Created in 11:56 2018/2/28
 * Modified By:
 */
public class DataSoureWrapper extends DruidDataSource implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (super.getDriverClassName() == null) {
            super.setDriverClassName(this.DataSourceproperties.determineDriverClassName());
        }
