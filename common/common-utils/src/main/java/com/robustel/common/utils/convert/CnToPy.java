 ...
 * </p>
 * <p>
 * 所在位置:com.zdnst.common.utilsCnToPy.java
 * </p>
 * <p>
 * 类名:CnToPy.java
 * </p>
...
public class CnToPy {
	...
	public static void main(String[] args) {
		...
		// System.out.println(getPinYinHeadChar(cnStr));
		cnStr = "熏,@";
		System.out.println(CnToPy.getMultiPinyin(cnStr));
		System.out.println(CnToPy.getPingYin(cnStr));
		System.out.println(CnToPy.getPinYinHeadChar(cnStr));
		System.out.println(CnToPy.getFirstHeadChar(cnStr));
	}
}